      ...
      >
        <SimpleTreeView>
          <TreeItem itemId="home" label="Home">
            ...
            />
            <TreeItem
              itemId="unavailability"
              label="Unavailability"
              onClick={() => handleNavigation("staff-unavailability")}
            />
          </TreeItem>
          <TreeItem itemId="cases" label="Cases">
            ...
            <TreeItem
              itemId="case-details"
              label="Case Details"
              onClick={() => handleNavigation("case-details")}
            />
            <TreeItem
              itemId="case-notes"
              label="Case Notes"
          ...
          <TreeItem itemId="appointments" label="Appointments">
            <TreeItem
              itemId="appointment-lookup"
              label="Appointment Lookup"
              onClick={() => handleNavigation("appointment-lookup")}
            />
            <TreeItem
              itemId="pending-schedule"
              label="Initial Appts to be Scheduled"
              onClick={() => handleNavigation("pending-schedule")}
            />
          </TreeItem>
          {/* <TreeItem
              itemId="appointments-dashboard"
              label="Appointments Lookup"
