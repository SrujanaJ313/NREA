  ...
  return (
    <Stack direction="row" justifyContent="space-between">
      <Stack width="100%" spacing={0.75}>
        <Stack direction="row">
          <Stack direction={"row"} spacing={1} style={{ width: "25%" }}>
              ...
              <Tooltip
                title={
                  <>
                    ...
                    {caseDetails?.email || ""}
                    <br />
                    {caseDetails?.ssnLast4Digits
                      ? `SSN Last Four Digits: ${caseDetails.ssnLast4Digits}`
                      : ""}
                  </>
                }
                arrow
          ...
          <Stack direction={"row"} spacing={1} style={{ width: "25%" }}>
            <Typography className="label-text">Case Status:</Typography>
            <Typography>{`${caseDetails.caseStatus || ""}`}</Typography>
          </Stack>
        </Stack>
        <Stack direction="row">
          <Stack direction={"row"} spacing={1} style={{ width: "25%" }}>
